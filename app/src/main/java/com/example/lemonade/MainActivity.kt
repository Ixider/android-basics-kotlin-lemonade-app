...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        when(lemonadeState) {
            SELECT -> executeSelectState()
            SQUEEZE -> executeSqueezeState()
    ...
    private fun executeSelectState() {
    ...
    private fun executeSqueezeState() {
        squeezeCount++
        lemonSize--
    ...
    private fun setViewElements() {
        ...
        textAction.text = getString(state)
        ...
        val imageId = when(lemonadeState) {
